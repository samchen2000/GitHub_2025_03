...
class CameraApp:
    def __init__(self, window, window_title, video_source=0):
        ...
        sharpness_size_subframe = tk.Frame(self.sharpness_frame)
        sharpness_size_subframe.pack(side=tk.TOP, fill=tk.X, padx=5, pady=(5, 5))
        ttk.Label(sharpness_size_subframe, text="寬:").pack(side=tk.LEFT)
        self.sharpness_width_entry = ttk.Entry(sharpness_size_subframe, width=5)
        self.sharpness_width_entry.pack(side=tk.LEFT, padx=(0, 5))
        ttk.Label(sharpness_size_subframe, text="高:").pack(side=tk.LEFT)
        self.sharpness_height_entry = ttk.Entry(sharpness_size_subframe, width=5)
        self.sharpness_height_entry.pack(side=tk.LEFT, padx=(0, 10))
        self.set_sharpness_size_button = ttk.Button(sharpness_size_subframe, text="設定大小", command=self.apply_sharpness_rect_size)
        ...
        self.rectangle_sharpness = ResizableDraggableRectangle(
            ...
            on_change_callback=self.calculate_and_display_sharpness
        )
